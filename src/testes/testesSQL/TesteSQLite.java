...
public class TesteSQLite 
{
    ...
    public static void main(String args[])
    {
        ...
        LojaDAO lojaDAO = new LojaDAO();
        ArrayList<Loja> lojas = lojaDAO.selectLojaPorNome("ABC", 3);
        for(Loja l : lojas)
        {
            System.out.println(l.getNome() + " " + l.getId());
        }
        

        ProdutoDAO produtoDAO = new ProdutoDAO();
        ArrayList<Produto> produtos = produtoDAO.selectProdutosPorNome("Furadeira Elétrica Profissional", 3);
        for(Produto p : produtos)
        {
